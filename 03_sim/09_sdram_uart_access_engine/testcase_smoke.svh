  initial begin : tc_smoke
    ...
    expect_response(1'b1, 21'h00030, 32'h0000_0001, 32'h0, "single write");

    log_info("ACCESS ENG TB", "case: single readback");
    issue_request(1'b0, 21'h00030, 32'h0);
    expect_response(1'b0, 21'h00030, 32'h0000_0001, 32'h0, "single readback");

    log_info("ACCESS ENG TB", "case: next linear word read");
    read_req_count_q = read_req_count;
    issue_request(1'b0, 21'h00031, 32'h0);
    expect_response(1'b0, 21'h00031, 32'h0000_0002, 32'h0, "next linear word read");
    ...
    expect_response(1'b1, 21'h00343, 32'h0000_0001, 32'h0, "nonzero word write");
    issue_request(1'b0, 21'h00343, 32'h0);
    expect_response(1'b0, 21'h00343, 32'h0000_0001, 32'h0, "nonzero word readback");

    log_info("ACCESS ENG TB", "case: rewrite same word");
    issue_request(1'b1, 21'h00030, 32'hCAFE_BABE);
    expect_response(1'b1, 21'h00030, 32'h0000_0001, 32'h0, "rewrite same addr");
    read_req_count_q = read_req_count;
    issue_request(1'b0, 21'h00030, 32'h0);
    expect_response(1'b0, 21'h00030, 32'h0000_0001, 32'h0, "readback after rewrite");
    if (read_req_count != (read_req_count_q + 1)) begin
    ...
    expect_response(1'b1, 21'h00012, 32'h0000_0001, 32'h0, "control-pattern write");
    issue_request(1'b0, 21'h00343, 32'h0);
    expect_response(1'b0, 21'h00343, 32'h0000_0001, 32'h0, "nonzero word still intact");
    issue_request(1'b0, 21'h00012, 32'h0);
    expect_response(1'b0, 21'h00012, 32'h0000_0001, 32'h0, "control-pattern readback");

    log_info("ACCESS ENG TB", "case: write timeout");
    inject_next_wr_timeout = 1'b1;
    issue_request(1'b1, 21'h00040, 32'h1234_5678);
    expect_response(1'b1, 21'h00040, 32'h0000_0001, ERR_SDRAM_WR_TO, "write timeout");
