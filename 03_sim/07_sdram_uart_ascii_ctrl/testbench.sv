...
module testbench;
  ...
  sdram_uart_ascii_ctrl u_dut (
    ...
    .O_CMD_BULK_IS_TEST(tb_cmd_bulk_is_test),
  ...
  task automatic expect_cmd(
    ...
    begin
      ...
      if ((tb_cmd_op !== exp_op) ||
          ...
          (tb_cmd_bulk_is_test !== exp_bulk_is_test) ||
        ...
        log_fatal(
          ...
          "ASCII CTRL TB",
          $sformatf(
            "cmd mismatch %s op=%0d status=%0b bulk_rd=%0b bulk_test=%0b addr=0x%05h data=0x%08h words=0x%05h",
            label,
            tb_cmd_op,
            tb_cmd_is_status,
            tb_cmd_bulk_is_read,
