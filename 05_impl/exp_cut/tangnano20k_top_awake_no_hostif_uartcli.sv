...
module tangnano20k_top(
  ...
  );  assign l_sdram_raw_rx_bypass_100m = 1'b0;
  assign l_sdram_raw_tx_mode_100m   = 1'b0;
  assign l_sdram_raw_tx_valid_100m  = 1'b0;
  assign l_sdram_raw_tx_data_100m   = 8'h00;
  assign l_src1_evt_valid_100m      = 1'b0;
  assign l_src1_evt_id_100m         = 8'h00;
  assign l_src1_arg0_100m           = 32'h0000_0000;
  assign l_src1_arg1_100m           = 32'h0000_0000;
  assign l_src1_arg2_100m           = 32'h0000_0000;
  assign l_src2_evt_valid_100m      = 1'b0;
  assign l_src2_evt_id_100m         = 8'h00;
  assign l_src2_arg0_100m           = 32'h0000_0000;
  assign l_src2_arg1_100m           = 32'h0000_0000;
  assign l_src2_arg2_100m           = 32'h0000_0000;
  assign l_sdram_init_done          = O_sdrc_init_done;
  assign l_sdram_test_active        = 1'b0;
  assign l_sdram_test_pass          = 1'b0;
  assign l_sdram_test_fail          = 1'b0;
  assign l_sdram_host_busy          = 1'b0;
  assign l_hostif_sdrc_wr_n         = 1'b1;
  assign l_hostif_sdrc_rd_n         = 1'b1;
  assign l_hostif_sdrc_addr         = 21'h000000;
  assign l_hostif_sdrc_data_len     = 8'h00;
  assign l_hostif_sdrc_dqm          = 4'h0;
  assign l_hostif_sdrc_data         = 32'h0000_0000;
...
//	);
  ...
  //---------------------------------------------------------------------------------------------  assign l_src_evt_ready      = '0;
  assign l_src_enable         = '0;
  assign soft_rst_req_cli_24m = 1'b0;
  assign l_cli_rx_valid_24m   = 1'b0;
  assign l_cli_rx_data_24m    = 8'h00;
  assign uart_esp_tx          = 1'b1;
