...
create_generated_clock -name CLK_SDRAM_100M -source [get_pins {u0_gowin_pll/rpll_inst/CLKOUT}] -multiply_by 25 -divide_by 6 [get_pins {u0_gowin_rpll_sdram/rpll_inst/CLKOUT}] -add
